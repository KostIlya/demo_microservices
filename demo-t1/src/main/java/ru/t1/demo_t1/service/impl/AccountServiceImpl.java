...
import ru.t1.demo_t1.util.AccountResponseMapper;
...
public class AccountServiceImpl implements AccountService {
    ...
    public Account getAccountByAccountId(UUID accountId) throws NoEntityException {
        Account account = accountRepository.findByAccountId(accountId).orElseThrow(() -> new NoEntityException("Счета с accountId " + accountId + " не существует."));
        return account;
    }
